...
func TestGet_setting(t *testing.T) {
	t.Run("규칙 러너 테스트", func(t *testing.T) {
		apiVersion := "v1"
		channelId := "bee4b42475b5937226b8b7ccbe2eb2dc"

		res, err := GetSetting(apiVersion, channelId)
		if err != nil {
	...
	t.Run("규칙 소풍왔니 테스트", func(t *testing.T) {
		apiVersion := "v1"
	...
	t.Run("규칙 강퀴88 테스트", func(t *testing.T) {
		apiVersion := "v1"
	...
	t.Run("규칙 시라유키히나 테스트", func(t *testing.T) {
		apiVersion := "v1"
